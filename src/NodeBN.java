...
public class NodeBN {
    ...
    private ArrayList<NodeBN> children = new ArrayList<NodeBN>();
...
//        return this.getFactor();
    ...
    public ArrayList<NodeBN> getChildren() {
        return children;
    }

    public void setChildren(ArrayList<NodeBN> children) {
        this.children = children;
    }
    public void addChildren(NodeBN child) {
